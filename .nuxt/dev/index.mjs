...
import { escapeHtml } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/ufo/dist/index.mjs';
...
import destr, { destr as destr$1 } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/node-mock-http/dist/index.mjs';
...
import { digest } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/source-map/source-map.js';
...
import { walkResolver } from 'file://C:/Users/Leo/Desktop/mysite/node_modules/unhead/dist/utils.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Leo/Desktop/mysite","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Leo/Desktop/mysite/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Leo/Desktop/mysite/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Leo/Desktop/mysite/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Leo/Desktop/mysite/.data/kv"}));
...
const _qRekKWz1bmGtyrLwXtkygooZZgBJT3CumTGlxdG4 = (function(nitro) {
...
const _iHMqggp8P8UGhxluJsLYS6Wzv9S6homd9HqACC85wlU = (nitroApp) => {
...
const plugins = [
  _qRekKWz1bmGtyrLwXtkygooZZgBJT3CumTGlxdG4,
_iHMqggp8P8UGhxluJsLYS6Wzv9S6homd9HqACC85wlU
];
...
const _lazy_mJDKHX = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_mJDKHX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_mJDKHX, lazy: true, middleware: false, method: undefined }
];
