...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-SMMwe85K.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bu1UFtpv.mjs'));
